...
class Student extends Person {
    ...
    graduate() {
        if(this.grade >= 70) return `Congrats! ${this.name} has graduated!`
        return `${this.name} needs to complete more assignments to increase score`
    }
}
